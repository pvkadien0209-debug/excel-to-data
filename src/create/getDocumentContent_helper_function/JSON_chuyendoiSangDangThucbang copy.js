...
const ChuyenDoi_Buoc_1 = {
  HuongDan: () => {
    $("#ResID04").text(
      ...
      Ban đầu là file excel gồm 1 (HD-Bmark	HD-02	HD-03			getIndexInTable	type	fsp	01-qs-01	01-aw-01	01-submit-01
),2 (ZZZZA1	ZZZZB1	ZZZZB2	ZZZZB3	ZZZZB4
)row =4,3 (HD-01	HD-02	HD-03	HD-04	HD-05	IFname	IFdes	IF-audiocode
); => bấm lấy LayBang => bấm Daco.. => down về file excel | từ file excel chọn 11-20 Ko chuyển đổi ABC bấm tranMutiset =>copy lấy json auido là (1) sau đó bấm lấy json down file json`
    );
  },
